...
for (gene in levels(combined.data$Gene)[1:4]) {
...
for (gene in levels(d24b.data$Gene)[1:4]) {
...
for (uas in levels(combined.data$UAS)[1:5]) {
...
for (uas in levels(d24b.data$UAS)[1:5]) {
  for (gender in levels(d24b.data$Gender)) {
