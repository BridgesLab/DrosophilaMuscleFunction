...
```{r myod-quantification, message=FALSE, warning=FALSE, dev=c('png','pdf')}
...
```{r s6-quantification, warning=FALSE, dev=c('png','pdf')}
...
```{r akt-quantification, warning=FALSE, dev=c('png','pdf')}
...
```{r horse-serum, message=FALSE, dev=c('png','pdf')}
